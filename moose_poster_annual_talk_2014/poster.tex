...
\newcommand{\HEADING}[1]
{
    ...
    %\MOOSELOGO
    \fontsize{2cm}{1cm}\selectfont \textcolor{black}{#1}
    \vspace{0.5cm}
}

\newcommand{\SECTION}[1]
{
    {\fontsize{1.5cm}{1.5cm}\selectfont \textsc{\textcolor{blue}{#1}}\par}
    \vspace{0.5cm}
}
...
\begin{tikzpicture}
    ...
    \node [] (gpl) at ([xshift=23cm,yshift=-2cm]title.east) {
        \includegraphics[height=3cm,width=8cm]{./images/gplv3.png}
    };
\end{tikzpicture}
...
\begin{Figure}
    \HEADING{1. Why Multiscale?}
        ...
        \begin{itemize}[]
            ...
            \item \TEXT{We have developed \textcolor{black}{\textsc{MOOSE}} the Multiscale
        ...
        \node[rectangle, minimum width=12cm, minimum height=6.0cm,
            draw, rounded corners] (chemical) at (10.0,4.5) {};
...
\HEADING{2. Some projects using MOOSE}
    ...
    \SECTION{2.1 Modelling Memory}
     ...
     \begin{tikzpicture}[
        spy using outlines={circle
         ...
         \node[below=4cm,text width=0.3\textwidth] {\CAPTION{A single neuron is
                 embedded in a lattice of a neural network}};
     ...
     \begin{tikzpicture}
         \node[] (resultb) {
             \includegraphics[width=0.45\textwidth]{./images/spike_raster.png}
         };
     \end{tikzpicture}
...
\begin{Figure}
    ...
    \begin{tikzpicture}
        \node[] (caption) {
            \begin{minipage}{0.35\textwidth}
                \TEXT{
                    Network coding and computation in olfaction and somatosensory
    ...
    \begin{tikzpicture}
        \node[] (result) {
            \includegraphics[width=0.6\textwidth]{./images/aditya_work.png}
        };
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node[] (robust) {
            \includegraphics[width=\textwidth]{./images/subha.png}
        };
    \end{tikzpicture}%
...
\begin{Figure}
    ...
    \SECTION{2.4 Modelling Chemical Signalling Pathways}
    ...
    \begin{tikzpicture}
        \node [] (harsha) {
            \includegraphics[width=0.4\textwidth]{./images/run_view_result.png}
        };
    \end{tikzpicture}

    \SECTION{2.5 Robustness of Chemical Switches}
