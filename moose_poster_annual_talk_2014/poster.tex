...
\newcommand{\SECTION}[1]
{
    {\fontsize{1.75cm}{1.5cm}\selectfont \textsc{\textcolor{black}{#1}}\par}
}
...
\newcommand{\TEXT}[1]
{
   { \fontsize{1.5cm}{1.2cm}\fontfamily{\sfdefault}\selectfont {#1}\par }
}
...
\begin{Figure}
    ...
    \SECTION{3.2 Single column Thalamacortical Model}

    \begin{tikzpicture}
        \node [] (subha) {
            \includegraphics[width=0.5\textwidth]{./images/connectivity_cell_types.png}
        };
    \end{tikzpicture}

    \SECTION{3.3 TODO: text herei}
    \begin{tikzpicture}
        \node[] (robust) {
