...
\begin{Figure}
    ...
    \begin{Figure}
        ...
        \SECTION{Modular solvers for multi-scaling}

        \begin{tikzpicture}
            \node[] (image) {
                \includegraphics[width=0.2\textwidth]{./images/stochastic_solver.png}
            }; 
            \node[below=6cm] {\CAPTION{Stochastic(GSSA): GSolve}};
        \end{tikzpicture} \hfill
        \begin{tikzpicture}
            \node[] (image) {
                \includegraphics[width=0.2\textwidth]{./images/ksolve_dsolve.png}
            };
            \node[below=6cm] {\CAPTION{ODE + Diffusion: KSolve + DSolve}};
        \end{tikzpicture} \hfill
        \begin{tikzpicture}
            \node[] (image) {
                \includegraphics[width=0.2\textwidth]{./images/hsolve.png}
            };
            \node[below=6cm] {\CAPTION{Electrical: HSolve}};
        \end{tikzpicture}
