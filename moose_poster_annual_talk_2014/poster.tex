...
\begin{Figure}
    ...
    \vspace{1cm}
    \TEXT{We have developed \textcolor{black}{\textsc{MOOSE}} the Multiscale
        Object Oriented Simulation Environment, to model plasticity and brain
        computation across scales.}


    \TEXT{\bf Modular solvers available in MOOSE}
...
\begin{Figure}
    ...
    %% One more model here.
    \SECTION{2.3 Modelling Signalling Pathways}
    \begin{tikzpicture}
        \node[] (robust) {
    ...
    %\SECTION{2.3 Single column Thalamacortical Model}
