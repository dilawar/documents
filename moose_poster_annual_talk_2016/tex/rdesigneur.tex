...
\begin{tikzpicture}[scale=1,
    ...
    \node [circle, draw] (rdesigneur) at (0,0) {\texttt{moose.redesigneur}};

    { [ xshift=-0.5\textwidth,yshift=0.0\textwidth]
        % neuromorpho 
        \node[rectangle] (neuromorphoSummary) {
            \includegraphics[width=0.5\textwidth]{./../_images/neuromorpho_summary.png}
        };
        \node[] (single_neuron) at (neuromorphoSummary.north) {
            \includegraphics[width=0.2\textwidth]{../images/neuron_with_spine.png}
        };
    }

    { [ yshift=0.5\textwidth ]
        \node[circle] (channelExample)  {
            \includegraphics[width=0.3\textwidth]{./../_images/channelpedia_example.png}
        };
    }
